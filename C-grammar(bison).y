...
function_definition		: declaration_specifiers declarator declaration_list compound_statement          {printf("\tReduced  function_definition>declaration_specifiers declarator declaration_list compound_statement\n");}
						...
						;
declaration				: declaration_specifiers init_declarator_list SEMI_COLON                         {printf("\tReduced  declaration>declaration_specifiers init_declarator_list SEMI_COLON\n");}
...
direct_declarator			: IDENTIFIER                                                                      {printf("\tReduced  direct_declarator>IDENTIFIER\n");} 
							...
							| direct_declarator LEFT_BRACKETS constant_expression RIGHT_BRACKETS               {printf("\tReduced  direct_declarator>direct_declarator LEFT_BRACKETS constant_expression RIGHT_BRACKETS\n");}
							| direct_declarator LEFT_BRACKETS RIGHT_BRACKETS                                     {printf("\tReduced  direct_declarator>direct_declarator LEFT_BRACKETS RIGHT_BRACKETS \n");}
